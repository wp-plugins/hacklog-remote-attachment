...
//		}
	...
	{
		add_options_page(__('Hacklog Remote Attachment Options', self::textdomain), __('Hacklog Remote Attachment', self::textdomain), 'manage_options', HACKLOG_RA_LOADER, array(__CLASS__, 'plugin_options')
		);
	}
